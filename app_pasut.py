...
with st.sidebar:
    ...
    st.markdown("<p style='text-align: center; color: #1e3a8a; margin-top: -7px; font-size: 1rem; font-weight: bold;'>STASIUN METEOROLOGI MARITIM TANJUNG PRIOK</p>", unsafe_allow_html=True)
    st.divider()
