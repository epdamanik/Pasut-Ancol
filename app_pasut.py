...
if df_pred is not None and not df_pred.empty:
    ...
    if not df_plot.empty:
        ...
        # Update Tinggi Grafik (Height) ke 460
        fig.update_layout(height=460, template="plotly_white", margin=dict(l=10, r=10, t=30, b=10), hovermode="x unified", legend=dict(orientation="h", yanchor="bottom", y=1.02, xanchor="right", x=1))
