...
st.markdown("""
    ...
    /* 1. KHUSUS MAIN CONTENT (TENGAH) - WARNING JADI ORANGE */
    /* [data-testid="stMain"] memastikan Sidebar TIDAK KENA */
    ...
    /* 2. KHUSUS MAIN CONTENT (TENGAH) - ERROR JADI MERAH */
    ...
    /* 3. PROTEKSI SIDEBAR - INFO TETAP BIRU ASLI */
    ...
    .summary-box {
        ...
        border-radius: 10px !important; border-left: 5px solid #1e3a8a !important; 
        text-align: center !important;
    }
    .summary-text { font-weight: 850 !important; color: #0f172a !important; }
...
with st.sidebar:
    ...
    # CSS di atas menjamin ini TETAP BIRU
...
st.markdown(f"""
    <div style="text-align: center;">
        <h2 style="margin: 0; color: #0f172a; font-weight: bold;">STASIUN METEOROLOGI MARITIM TANJUNG PRIOK</h2>
        <p style="color: #1e40af; font-weight: 700;">Monitoring Tinggi Muka Air (TMA) Real-Time</p>
    </div>
    """, unsafe_allow_html=True)
st.divider()
...
if df_pred is not None and not df_pred.empty:
    ...
    # LOGIKA ALERT (Hanya ini yang jadi Orange/Merah)
    ...
    m3.metric("Psr. Ikan", f"{live_data['bpbd']:.2f} m" if live_data["bpbd"] else "N/A")
    ...
    fig.add_trace(go.Scatter(x=df_p[col_tgl], y=df_p[col_val], name='Prediksi', line=dict(color='#64748b', dash='dot')))
    
    fig.add_vline(x=sekarang, line_width=2, line_dash="dash", line_color="green")
    fig.add_hline(y=2.5, line_dash="dash", line_color="red", annotation_text="AWAS")
    ...
    with c_f2:
        st.write("BMKG Maritim Tanjung Priok © 2026")
