...
with st.sidebar:
    ...
    st.divider()
    st.info("Data prediksi pasang surut dihitung menggunakan metode Analisis Harmonik berdasarkan data historis Tinggi Muka Air (TMA) Pompa Pasar Ikan I dari Dinas Sumber Daya Air (DSDA) Provinsi DKI Jakarta tahun 2025.")
